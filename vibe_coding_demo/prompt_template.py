...
警告：不要添加除了 <question></question>、<thought></thought>、<action></action>、<observation></observation>、<final_answer></final_answer> 外的其他标签。
你只能使用以上标签。
...
- E:\Projects\VideoCode\Agent的概念、原理与构建模式\snake 这是用户的项目根目录
⸻
